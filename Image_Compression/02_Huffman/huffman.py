...
class HuffmanApp:
    ...
    def create_widgets(self):
        ...
        ttk.Label(
            header,
            text="Huffman Image Compression",
            font=("Segoe UI", 22, "bold")
        ).pack(anchor="w")
    ...
    def build_tree(frequencies):
        ...
        while len(heap) > 1:
            ...
            freq1, _, left = heapq.heappop(
                heap
            )

            freq2, _, right = heapq.heappop(
                heap
            )
    ...
    def decompress(self):
        ...
        try:
            ...
            self.status_var.set(
                "Huffman decompression completed."
            )
